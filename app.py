...
# Streamlit UI
# =========================================
st.set_page_config(page_title="BSE Announcements Tracker", layout="wide")
st.title("📈 BSE Announcements Tracker")
st.caption("Fetch BSE announcements → pick PDF → upload to chatgpt → summarize")
